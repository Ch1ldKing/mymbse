...
describe('Directive: mmsViewTable', function () {
    ...
    function replaceDom(trs) {
        ...
        trs.first()
            ...
            .find('view-cf')
            .replaceWith('<view-cf mms-cf-type="name"><span>ggg</span></view-cf>');
        trs.first()
            .children('td:nth-child(2)')
            .find('view-cf')
            .replaceWith('<view-cf mms-cf-type="doc"><p><span class="no-print">ad</span></p></view-cf>');
        trs.first()
            .children('td:nth-child(3)')
            .find('mms-cf')
            .first()
            .replaceWith('<view-cf mms-cf-type="name"><span>value1</span></view-cf>');
        // child one again coz the earlier replace mms-cf with sth else
        trs.first()
            .children('td:nth-child(3)')
            .find('mms-cf:nth-child(1)')
            .replaceWith('<view-cf mms-cf-type="name"><span>value2</span></mms-cf>');
        //
        ...
        innerTableRows
            ...
            .children('td:nth-child(1)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="name"><span>value1</span></mms-cf>');
        innerTableRows
            .first()
            .children('td:nth-child(2)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="val"><span>234111070</span></mms-cf>');
        $(innerTableRows[1])
            .children('td:nth-child(1)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="name"><span>value2</span></mms-cf>');
        $(innerTableRows[1])
            .children('td:nth-child(2)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="val"><span class="no-print">(no value)</span></mms-cf>');

        /** Second row **/
        $(trs[1])
            .children('td:nth-child(1)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="name"><span>aaa</span></mms-cf>');
        $(trs[1])
            .children('td:nth-child(2)')
            .find('mms-cf')
            .replaceWith('<mms-cf mms-cf-type="doc"><span>adfew dfvdfdsf</span></mms-cf>');
    }
